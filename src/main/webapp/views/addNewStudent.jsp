...
<body>
	...
	<div id="right-panel" class="right-panel">
		...
		<div class="col-lg-9">
                        <div class="card">
                            <div class="card-header"><strong>New Student</strong></div>
                            <div class="card-body card-block">
                            <form action="student" method="post" enctype="multipart/form-data">
                                <div class="form-group"><label for="company" class=" form-control-label">student Name</label><input type="text" name="student_Name" id="company" placeholder="Enter your Full name" class="form-control"></div>
                                        ...
                                        <div class="form-group"><label for="street" class=" form-control-label">Email</label><input type="text" name="email" id="street" placeholder="Enter Email" class="form-control"></div>
                                            <div class="row form-group">
                                                <div class="col-8">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="form-group"><label for="postal-code" class=" form-control-label">Board Name</label><input type="text"  name="Board_name" id="postal-code" placeholder="Enter your Board" class="form-control"></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group"><label for="country"  class=" form-control-label">Batch Name</label><input type="text" id="country" name="Batch_name" placeholder="enter Batch" class="form-control"></div>
                                                     <div class="form-group"><label for="country"  class=" form-control-label">class</label><input type="text" id="stu_class" name="student_class" placeholder="enter class" class="form-control"></div>
                                                      <div class="form-group"><label for="country"  class=" form-control-label">student photo</label><input type="file" id="student_photo" name="studentfile" class="form-control"></div>
                                                       <div class="form-group"><label for="country"  class=" form-control-label">password</label><input type="text" id="password" name="password" placeholder="enter password" class="form-control"></div>
