		...
		<div class="col-lg-12">
			<div class="card">
				...
				<form action="teacher" method="post">
					...
					<input type="text" name="teacher_id" value="${t.teacher_id}"></input>
						<label for="inputSuccess2i" class=" form-control-label">
							teacher Name</label><input type="text" id="inputSuccess2i"
							placeholder=" enter teacher Name" name="teacher_name"
							class="form-control-success form-control" value="${t.teacher_name}"><br>
						
						<label for="inputSuccess2i" class=" form-control-label">
							email</label><input type="email" id="inputSuccess2i"
							placeholder=" enter email " name="email"
							class="form-control-success form-control" value="${t.email}"><br>
						
						<label for="inputSuccess2i" class=" form-control-label">
							mobile</label><input type="number" id="inputSuccess2i"
							placeholder=" enter mobile number" name="mobile"
							class="form-control-success form-control" value="${t.mobile}"><br>
							
						<label for="inputSuccess2i" class=" form-control-label">
							subject</label><input type="text" id="inputSuccess2i"
							placeholder=" enter subject Name" name="subject"
							class="form-control-success form-control" value="${t.subject}"><br>
							
						<label for="inputSuccess2i" class=" form-control-label">
							photo</label><input type="file" id="inputSuccess2i"
							 name="photo"
							class="form-control-success form-control" value="${t.teacher_photo}"><br>
							
							<label for="inputSuccess2i" class=" form-control-label">
							address</label><input type="text" id="inputSuccess2i"
							placeholder=" enter address" name="enter address"
							class="form-control-success form-control" value="${t.address}"><br>
							
							<label for="inputSuccess2i" class=" form-control-label">
							password</label><input type="password" id="inputSuccess2i"
							placeholder=" enter password" name="password"
							class="form-control-success form-control" value="${t.password}"><br>
