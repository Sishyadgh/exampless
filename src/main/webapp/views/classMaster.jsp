                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="addNewClass"><button class="btn btn-primary ml-2">+ Add new Class</button></a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach var="b" items="${cdata}">
                                        <tr>
                                            
                                            <td>${b.class_id}</td>
                                               <td>${b.class_name}</td>
                                                  
                                            <td><a href="editc?class_id=${b.class_id}"><button class="btn btn-info" >Edit</button></a></td>
                                            <td><a href="deletec?class_id=${b.class_id}"><button class="btn btn-danger" >Delete</button></a></td>
                                        </tr>
                                        </c:forEach>
