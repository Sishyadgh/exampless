...
<body>
	...
	<div id="right-panel" class="right-panel">
		...
		<div class="content mt-3">
			...
			<a href="boardMaster"><div class="col-xl-3 col-lg-6">
					<div class="card">
						<div class="card-body">
							<div class="stat-widget-one">
								...
								<div class="stat-content dib">
									...
									<div class="stat-digit">${totalBoard}</div>
								</div>
							</div>
						</div>
					</div>
			...
			<a href="batchMaster"><div class="col-xl-3 col-lg-6">
				<div class="card">
					<div class="card-body">
						<div class="stat-widget-one">
							<div class="stat-icon dib">
							...
							<div class="stat-content dib">
								...
								<div class="stat-digit">${totalBatch}</div>
							</div>
						</div>
					</div>
				</div>
			...
			<a href="classMaster"><div class="col-xl-3 col-lg-6">
				<div class="card">
					<div class="card-body">
						<div class="stat-widget-one">
							<div class="stat-icon dib">
							...
							<div class="stat-content dib">
								...
								<div class="stat-digit">${totalClass}</div>
							</div>
						</div>
					</div>
				</div>
			...
			<a href="subjectMaster"><div class="col-xl-3 col-lg-6">
				<div class="card">
					<div class="card-body">
						<div class="stat-widget-one">
							<div class="stat-icon dib">
							...
							<div class="stat-content dib">
								...
								<div class="stat-digit">${totalSubject}</div>
							</div>
						</div>
					</div>
				</div>
			...
			<a href="totalTeachers"><div class="col-xl-3 col-lg-6">
				<div class="card">
					<div class="card-body">
						<div class="stat-widget-one">
							<div class="stat-icon dib">
							...
							<div class="stat-content dib">
								...
								<div class="stat-digit">${totalteacher}</div>
							</div>
						</div>
					</div>
				</div></a>
				...
				<div class="card">
					<div class="card-body">
						<div class="stat-widget-one">
							...
							<div class="stat-content dib">
								<div class="stat-text">Total Videos</div>
								<div class="stat-digit">${totalvideos}</div>
							</div>
						</div>
					</div>
				</div>
