                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Board Master</li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <strong class="card-title">Board</strong>
                                <a href="addNewBoard"><button class="btn btn-primary ml-2">+ Add new Board</button></a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <c:forEach var="b" items="${data}">
                                        <tr>
                                            ...
                                            <td><a href="edit?id=${b.id}"><button class="btn btn-info" >Edit</button></a></td>
                                            <td><a href="del?id=${b.id}"><button class="btn btn-danger" >Delete</button></a></td>
                                        </tr>
                                        </c:forEach>
