                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <strong class="card-title">New Video</strong>
                                <a href="addNewVideo"><button class="btn btn-primary ml-2">+ Add new Video</button></a>
                            </div>
                            <div class="card-body">
                                             ...
                                             <td>${v.board}</td>
                                              <td>${v.batch}</td>
                                               <td>${v.teacher_class}</td>
                                                <td>${v.teacher_subject}</td>
                                                 <td>${v.video_link}</td>
                                                  
                                            <td><a href="editvideo?id=${v.id}"><button class="btn btn-info" >Edit</button></a>
                                            <a href="deletevideo?id=${v.id}"><button class="btn btn-danger" >Delete</button></a></td>
                                        </tr>
                                      </c:forEach> 
