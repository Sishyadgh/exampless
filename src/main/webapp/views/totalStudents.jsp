                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="addNewStudent"><button class="btn btn-primary ml-2">+ Add new Student</button></a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach var="c" items="${stu_data}">
                                        <tr>
                                            <td>${c.student_id}</td>
                                             ...
                                             <td>${c.email}</td>
                                              <td>${c.mobile}</td>
                                               <td>${c.board_name}</td>
                                                ...
                                                <td><a><img src="uploads/student/${c.student_photo}" width=50px></img></a></td>  
                                                  <td>${c.password}</td>
                                            <td><a href="studentedit?student_id=${c.student_id}"><button class="btn btn-info" >Edit</button></a>
                                            <a href="deletestudent?student_id=${c.student_id}"><button class="btn btn-danger" >Delete</button></a></td>
                                        </tr>
