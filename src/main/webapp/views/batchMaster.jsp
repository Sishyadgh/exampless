                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <strong class="card-title">Batch</strong>
                                <a href="addNewBatch"><button class="btn btn-primary ml-2">+ Add new Batch</button></a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach var="e" items="${batch}">
                                        <tr>
                                            <td>${e.batch_id }</td>
                                            <td>${e.batch_name}</td>
                                            <td><a href="editb?batch_id=${e.batch_id}"><button class="btn btn-info" >Edit</button></a></td>
                                            <td><a href="deleteb?batch_id=${e.batch_id}"><button class="btn btn-danger" >Delete</button></a></td>
                                        </tr>
                                        </c:forEach>
