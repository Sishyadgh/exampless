			...
			<div class="card">
				...
				<form action="batch" method="post">
					<div class="has-success form-group">
						...
						placeholder=" enter Batch Name" name="batch_name" class="form-control-success form-control"><br>
					<button class="btn btn-danger">Add</button>  <button class="btn btn-dark">Reset</button>  <button class="btn btn-success">View Batch's</button>
					</div>
					</form>
				</div>
			</div>
