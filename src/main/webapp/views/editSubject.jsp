		...
		<div class="col-lg-12">
			<div class="card">
				...
				<form action="subject" method="post">
					...
					<input type="text" name="subject_id" value="${sm.subject_id }"></input>
						<label for="inputSuccess2i" class=" form-control-label">
							Subject Name</label><input type="text" id="inputSuccess2i"
							placeholder=" enter subject Name" name="subject_name"
							class="form-control-success form-control" value="${sm.subject_name}"><br>
