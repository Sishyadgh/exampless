				...
				<form action="updatevideo" method="post">
					...
					<input type="hidden" name="id" value="${v.id}">
						<label for="inputSuccess2i" class=" form-control-label">
							...
							class="form-control-success form-control" value="${v.teacher_name}"><br>
						
					
						
						<label for="inputSuccess2i" class=" form-control-label">
							board</label><input type="number" id="inputSuccess2i"
							placeholder=" enter board" name="board"
							class="form-control-success form-control" value="${v.board}"><br>
							
						<label for="inputSuccess2i" class=" form-control-label">
							batch</label><input type="text" id="inputSuccess2i"
							placeholder=" enter batch" name="batch"
							class="form-control-success form-control" value="${v.batch}"><br>
							
						<label for="inputSuccess2i" class=" form-control-label">
							teacher class</label><input type="text" id="inputSuccess2i"
							 name="teacher_class" placeholder="enter class"
							class="form-control-success form-control" value="${v.teacher_class}"><br>
							
							<label for="inputSuccess2i" class=" form-control-label">
							teacher subject</label><input type="text" id="inputSuccess2i"
							placeholder=" enter teacher subject" name="teacher_subject"
							class="form-control-success form-control" value="${v.teacher_subject}"><br>
							
							<label for="inputSuccess2i" class=" form-control-label">
							video link</label><input type="url" id="inputSuccess2i"
							placeholder=" enter link" name="video_link"
							class="form-control-success form-control" value="${v.video_link}"><br>
