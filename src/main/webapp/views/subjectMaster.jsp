                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="addNewSubject"><button class="btn btn-primary ml-2">+ Add new Subject</button></a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach var="s" items="${sdata}">
                                        <tr>
                                            <td>${s.subject_id}</td>
                                            <td>${s.subject_name}</td>
                                            <td><a href="edits?subject_id=${s.subject_id}"><button class="btn btn-info" >Edit</button></a></td>
                                            <td><a href="deletes?subject_id=${s.subject_id}"><button class="btn btn-danger" >Delete</button></a></td>
                                        </tr>
